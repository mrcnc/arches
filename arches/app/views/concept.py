...
def paged_dropdown(request):
    ...
    results = Concept().get_child_edges(conceptid, ['member', 'hasTopConcept'], child_valuetypes=['prefLabel', 'sortorder', 'collector'], offset=offset, limit=limit, order_hierarchically=True, query=query, columns=columns)
